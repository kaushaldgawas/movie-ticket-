                    ...
                    <div class="booking-form-container">
                        <form action="spot.php" method="POST">
                            ...
                            <select name="date" required>
                                ...
                                <option value="12-3">March 12,2022</option>
                                <option value="13-3">March 13,2022</option>
                                <option value="14-3">March 14,2022</option>
                                <option value="15-3">March 15,2022</option>
                                <option value="16-3">March 16,2022</option>
                            </select>
